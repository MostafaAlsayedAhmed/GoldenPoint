...
export interface ApiAboutSectionAboutSection extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'About us / Why choose us sections';
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts and market analysis articles';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Relation<
      'manyToOne',
      'api::market-category.market-category'
    >;
...
export interface ApiCoursePackageCoursePackage
  extends Struct.CollectionTypeSchema {
  collectionName: 'course_packages';
  info: {
    description: 'Bundled course packages and subscriptions';
    displayName: 'Course Package';
    pluralName: 'course-packages';
    singularName: 'course-package';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::course-package.course-package'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
    ...
    packageType: Schema.Attribute.Enumeration<
      ['gold', 'platinum', 'vip', 'elite', 'custom']
    > &
...
export interface ApiCtaSectionCtaSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    style: Schema.Attribute.Enumeration<
      ['primary', 'secondary', 'dark', 'light', 'gradient']
    > &
...
export interface ApiHomepageManagerHomepageManager
  extends Struct.SingleTypeSchema {
  collectionName: 'homepage_manager';
  info: {
    description: 'Control homepage sections and layout';
    displayName: 'Homepage Manager';
    pluralName: 'homepage-managers';
    singularName: 'homepage-manager';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    activeAboutSection: Schema.Attribute.Relation<
      'oneToOne',
      'api::about-section.about-section'
    >;
    activeHero: Schema.Attribute.Relation<
      'oneToOne',
      'api::hero-banner.hero-banner'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqCount: Schema.Attribute.Integer &
    ...
    featuredArticle: Schema.Attribute.Relation<
      ...
      'api::article.article'
    >;
    latestArticlesCount: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 12;
          min: 3;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::homepage-manager.homepage-manager'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    showFeaturedArticle: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    showHero: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showLatestArticles: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    ...
    showProcess: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showServices: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showStatistics: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
export interface ApiMarketCategoryMarketCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'market_categories';
  info: {
    description: 'Different market types (US, European, Asian, etc.)';
    displayName: 'Market Category';
    pluralName: 'market-categories';
    singularName: 'market-category';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPartnershipPartnership extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    credentials: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    partnershipType: Schema.Attribute.Enumeration<
      ['strategic', 'training', 'platform', 'certification', 'sponsor']
    > &
      Schema.Attribute.DefaultTo<'strategic'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Investment services offered';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiStatisticStatistic extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Homepage statistics and counters';
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Company team members and experts';
...
export interface ApiTranslationTranslation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    pages_list: Schema.Attribute.JSON &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::course-package.course-package': ApiCoursePackageCoursePackage;
      ...
      'api::homepage-manager.homepage-manager': ApiHomepageManagerHomepageManager;
      'api::instructor.instructor': ApiInstructorInstructor;
      'api::market-category.market-category': ApiMarketCategoryMarketCategory;
